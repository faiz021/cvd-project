...
class Male extends patientdata {
    ...
    public function setAge_chol_points($age_chol_points) {
     //   $age_chol_points = CholPoints::chol_points_age($age_chol_points, Male::$gender);
    ...
    public function setChol_chol_points($chol_chol_points) {
     //   $chol_chol_points = CholPoints::cholesterol_chol_points($chol_chol_points, Male::$gender);
    ...
    public function setDiab_chol_points($diab_chol_points) {
     //   $diab_chol_points = CholPoints::diabetes_chol_points($diab_chol_points, Male::$gender);
    ...
    public function setDias_chol_points($dias_chol_points) {
      //  $dias_chol_points = CholPoints::diastolic_chol_points($dias_chol_points, Male::$gender);
    ...
    public function setHdl_chol_points($hdl_chol_points) {
       // $hdl_chol_points = CholPoints::hdl_chol_points($hdl_chol_points, Male::$gender);
    ...
    public function setSmoker_chol_points($smoker_chol_points) {  
      //  $smoker_chol_points = CholPoints::smoker_chol_points($smoker_chol_points, Male::$gender);
    ...
    public function setSyst_chol_points($syst_chol_points) {
      //  $syst_chol_points = CholPoints::systolic_chol_points($syst_chol_points, Male::$gender);
